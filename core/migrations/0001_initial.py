    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Religious', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Kedarnath', max_length=100)),
                ('image', models.ImageField(default='package.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is a Package.', null=True)),
                ('price', models.DecimalField(decimal_places=2, default=5000, max_digits=99999)),
                ('old_price', models.DecimalField(decimal_places=2, default=10000, max_digits=99999)),
                ('specifications', models.TextField(blank=True, null=True)),
                ('package_status', models.CharField(choices=[('draft', 'Draft'), ('disabled', 'Disabled'), ('rejected', 'Rejected'), ('in_review', 'In Review'), ('published', 'Published')], default='in_review', max_length=10)),
